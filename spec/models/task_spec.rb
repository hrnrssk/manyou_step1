...
RSpec.describe Task, type: :model do
  describe 'タスクモデル機能', type: :model do
    ...
    describe '検索機能' do
      before do
        FactoryBot.create(:task, name: "テスト1", detail: 'テスト1', deadline: '2020/08/1', status: '着手中', priority: '1', author: 'sasaki')
        FactoryBot.create(:second_task, name: "タスク2", detail: 'テスト2', deadline: '2020/08/2', status: '未着手', priority: '2', author: 'hironori')
        FactoryBot.create(:third_task, name: "タスク3", detail: 'テスト3', deadline: '2020/08/10', status: '未着手', priority: '3', author: 'hironori')
      end
